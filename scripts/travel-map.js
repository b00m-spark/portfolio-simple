const visitedCountries = [
    ...
    { name: "Austria", mapNames: ["Austria"], mapIds: ["040"], note: "Vienna is randomly musical. Randomly, I looked on the opera hall website and decided to buy a 20€ standing ticket to The Magic Flute. Randomly, I found a stamp collection at a shop featuring musicians who spent their time in Austria, and visited many of their tombs. Randomly, I came out of the Golden Hall and run into a big disco party right across the street, with equally passionate music." },
    { name: "Russia", mapNames: ["Russia"], mapIds: ["643"], note: "Russia is in my opinion hugely underrated. A rich and complex history woven into its bones, it also has no less of a contemporary and vibrant spirit. I spent way more time than I should at a lot of places, before a favorite Rubens painting, wandering endlessly in a palace hallway, before the Gulf of Finland blue waters, and attending an orthodox liturgy and let the beautiful ceiling cure my feet's pain." },
];
